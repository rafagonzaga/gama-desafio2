        ...
        <Container>
            <div className='nav'>
                <div>
                    ...
                    <img src="https://www.adobe.com/br/express/create/logo/media_1047bd5c98014fa5b8c25432e9ce808823df55bde.jpeg?width=2000&format=webply&optimize=medium" alt="king mobile" width="200px" height="auto" />
                </div>

                <div className="cart">
                    <img src={Cart} alt="cartshop" width="50px" height="auto" />
            ...
            <section className = "cards">
                {data.map((prod, index) => (
                    <div className="product-content" key={prod.id}>
                        ...
                        <h6>{prod.price}</h6>
                        <button onClick={() => handleCart(index)}>Adicionara ao carrinho</button>
                    </div>
